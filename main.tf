...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  dynamic "origin" {
    ...
    content {
      ...
      origin_access_control_id = lookup(origin.value, "origin_access_control_id", lookup(lookup(aws_cloudfront_origin_access_control.s3_distribution, lookup(origin.value, "origin_access_control", ""), {}), "id", null))
